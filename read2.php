...
//$q1="Select * from Reply where Reply.postID=$pid and Reply.categoryID=1";
$q1="select * from Reply r, users u where r.postID=$pid and u.user_id=r.user_id and categoryID=1 order by postedDate desc";
