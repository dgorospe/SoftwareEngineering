...
if (isset($_POST['submitted'])) {
    ...
    if (empty($errors)) { // If everything's OK.
        ...
        <p>You are now registered and can <a href="login.php">log in!</a></p><p><br /></p>'
...
<form class="form-signin" role="form" action="register.php" method="post">
    ...
    <p>First Name: <input type="normal" class="form-control" placeholder="Your first name" required autofocus name="first_name" maxlength="30" value="<?php if (isset($_POST['first_name'])) echo $_POST['first_name']; ?>" /></p>
	
    <p>Last Name: <input type="normal" class="form-control" placeholder="Your last name" required name="last_name" maxlength="30" value="<?php if (isset($_POST['last_name'])) echo $_POST['last_name']; ?>" /></p>
	
    <p>Email Address: <input type="email" class="form-control" placeholder="Email address" required name="email" maxlength="80" value="<?php if (isset($_POST['email'])) echo $_POST['email']; ?>"  /> </p>
